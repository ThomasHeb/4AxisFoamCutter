    ...
    switch(letter) {
      ...
      case 'M':
        ...
        switch(int_value) {
          ...
          case 3: case 4:  gc.hotwire = 1; break;
          case 5:          gc.hotwire = 0; break;
...
//          case 9: gc.coolant_mode = COOLANT_DISABLE; break;
  ...
  if (sys.state != STATE_CHECK_MODE) {
    ...
    // [M3,M4,M5]: Update hotwire state
    hotwire_run(gc.hotwire, gc.hotwire_pwr);
  ...
  switch (non_modal_action) {
    ...
    case NON_MODAL_GO_HOME_0: case NON_MODAL_GO_HOME_1:
      ...
      if (axis_words) {
        ...
        mc_line(target[X_AXIS], target[Y_AXIS], target[U_AXIS], target[Z_AXIS], settings.default_seek_rate, false, C_LINE);
      }
      ...
      ///8c1  : line
      mc_line(coord_data[X_AXIS], coord_data[Y_AXIS], coord_data[U_AXIS], coord_data[Z_AXIS], settings.default_seek_rate, false, C_LINE);

...
#ifdef FOAM_CUTTER
#define DEFAULTS_FOAMCUTTER
// always upload defaults parameter -> 1
#define ALWAYS_DEFAULTS_SETTINGS          0       
#endif
#ifdef LASER_CUTTER
#define DEFAULTS_LASERCUTTER
// always upload defaults parameter -> 1
#define ALWAYS_DEFAULTS_SETTINGS          0  
#endif

// ==================================================================================================
// Supportet file Extensions for gcode files on SD Cardrr
#define SUPPORTED_FILE_EXTENSTIONS    {".nc", ".NC", ".gcode", ".GCODE"}
#define N_SUPPORTED_FILE_EXTENSTIONS  4

// ==================================================================================================
// Default pin mappings for Arduino MEGA 2560. Other processor types
...
#define LIMITS_SW_DEBOUNCE                // Debouces the limit and estopp by software
#endif
#ifdef LASER_CUTTER
#define USE_LIMIT_SWITCHES                1  
#define LIMITS_SW_DEBOUNCE                // Debouces the limit and estopp by software
...
#endif
#ifdef LASER_CUTTER
#define USE_BUTTONS                       0  // Must be 0, Buttons are not implementet for Laser
#endif

// ==================================================================================================
#ifdef FOAM_CUTTER
#define FAN_MAX_RPM 255     // Max fan RPM. This value is equal to 100% duty cycle on the PWM.
#define FAN_MIN_RPM 0       // Min fan RPM. This value is equal to (1/256) duty cycle on the PWM.
#endif
...
#endif
#ifdef LASER_CUTTER
#define ACCELERATION_TICKS_PER_SECOND     7L
#endif
// ==================================================================================================
...
#ifdef FOAM_CUTTER
#define HOMING_SEARCH_CYCLE_0 ((1<<X_AXIS) | (0<<Y_AXIS) | (1<<U_AXIS) | (0<<Z_AXIS))       // move X,U at the same time.
#define HOMING_SEARCH_CYCLE_1 ((0<<X_AXIS) | (1<<Y_AXIS) | (0<<U_AXIS) | (1<<Z_AXIS))       // Then move Y,Z at the same time.
// #define HOMING_SEARCH_CYCLE_2 ((0<<X_AXIS) | (0<<Y_AXIS) | (0<<U_AXIS) | (0<<Z_AXIS))    // Uncomment and add axes mask to enable
#define HOMING_LOCATE_CYCLE   ((1<<X_AXIS) | (1<<Y_AXIS) | (1<<U_AXIS) | (1<<Z_AXIS)) //|(1<<Y_AXIS)|(1<<Z_AXIS)) // Must contain ALL search axes
#endif
#ifdef LASER_CUTTER
#define HOMING_SEARCH_CYCLE_0 ((1<<X_AXIS) | (1<<Y_AXIS))                                   // move X,Y at the same time.
